    ...
    public void showFrame() {
        ...
        if(passenger.getDeparture().equalsIgnoreCase(passenger.getDestination())) {
            ...
            try {
                ...
                bw = new BufferedWriter(new FileWriter("BookingDetail.txt",true));

                bw.write("\n\nFirst Name\t\t\t\t\tLast Name\t\t\t\t\tFrom\t\t\t\t\tTo\t\t\t\t\tAdults\t\t\t\t\tChildren\t\t\t\tBooking date\t\t\t\tBook time\t\t\t\t   Class\t\t\t\t   Meal");
                bw.write("\n"+passenger.getFirstName());
                bw.write("\t\t\t\t\t"+passenger.getLastname());
                bw.write("\t\t\t\t\t"+passenger.getDeparture());
                bw.write("\t\t\t\t\t"+passenger.getDestination());
                bw.write("\t\t\t\t\t"+passenger.getNoOfAdults());
                bw.write("\t\t\t\t\t"+passenger.getNoOfChildren());
                bw.write("\t\t\t\t\t"+passenger.getBookingDate());
                bw.write("\t\t\t\t\t     "+passenger.getBookingTime());
                bw.write("\t\t\t\t\t     "+passenger.getFlightClass());
                bw.write("\t\t\t\t\t"+passenger.getMeal());
                bw.close();
            ...
            classFlight.setBounds(150, 500, 100, 60);
